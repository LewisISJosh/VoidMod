...
@Mod("void") public class VoidMod {
	public static final Logger LOGGER = LogManager.getLogger(VoidMod.class);
	public static final String MODID = "void";
	public VoidMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		
		VoidModBlocks.REGISTRY.register(bus);
		
		VoidModItems.REGISTRY.register(bus);
		
		
		VoidModTabs.REGISTRY.register(bus);
